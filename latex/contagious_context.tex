...
real models is a conjecture, but a sharper one here: the induction (copy)
mechanism~\cite{olsson2022} is precisely a longest-match cache, so the de Bruijn determinism of
\S\ref{sec:orders} and the
